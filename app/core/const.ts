...
export const AES_KEY_HEX =
    process.env.EXPO_PUBLIC_AES_KEY ||
    Constants.expoConfig?.extra?.EXPO_PUBLIC_AES_KEY
export const AES_IV_HEX =
    process.env.EXPO_PUBLIC_AES_IV ||
    Constants.expoConfig?.extra?.EXPO_PUBLIC_AES_IV
